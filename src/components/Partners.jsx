...
const PartnerImage = (props) => {
    return (
        <div className="">
            <img className="partner-image" src={props.src} alt={props.alt}/>
        </div>
    )
}
...
const Partners = () => {
    return (
        <div>
            <h1 className="section-header">{navLinks.find((item) => item.id === "partners").title}</h1>
